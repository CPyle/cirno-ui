...
PitBull4DB = {
					...
					["layouts"] = {
						["TargetsTarget"] = {
							...
							["elements"] = {
								["Name + HP"] = {
									["font"] = "Skurri",
									["exists"] = true,
									["code"] = "[Name:ClassColor:Truncate(32) (~IsMaxHP ? ~Dead ? \" || \" PercentHP:HPColor \"%\":HPColor) (Dead ? \" || \" \"Dead\":Color(\"922E21\"))] [Offline ? \"Offline\":Color(\"8D8483\")]",
									["location"] = "center",
									["attach_to"] = "BlankSpace;Default",
									["size"] = 0.85,
								},
						...
						["yopart"] = {
							...
							["elements"] = {
								["Name"] = {
									...
									["code"] = " [Outline][Name:ClassColor:Truncate(44)]",
									["size"] = 0.9,
								},
								["dead"] = {
									["font"] = "Impact",
									...
									["position"] = 1.00002,
									["location"] = "right",
									["code"] = "[(~IsMaxHP ? ~Dead ? Outline PercentHP:Round:HPColor)]",
									["attach_to"] = "HealthBar",
									["size"] = 0.8,
								},
							},
						...
						["raid 3 test"] = {
							...
							["elements"] = {
								["Name"] = {
									...
									["position"] = 1.00001,
									["location"] = "edge_bottom",
									["code"] = " [Outline][Name:ClassColor:Truncate(25)]",
									["size"] = 0.8,
								},
								["dead"] = {
									["font"] = "Impact",
									...
									["position"] = 1.00002,
									["location"] = "edge_top",
									["code"] = "[Outline][(Dead ? \"DEAD\":Red) (~Dead ? if HP < 7500 then\n    \"LOW\":HPColor\nend)]\n",
									["size"] = 0.85,
								},
							},
						},
						["focusnew"] = {
							...
							["elements"] = {
								...
								["HP percent"] = {
									...
									["position"] = 3,
									["location"] = "right",
									["code"] = "[(~IsMaxHP ? ~Dead ? Outline PercentHP:Percent:HPColor)] ",
									["attach_to"] = "HealthBar",
								},
								["Reputation"] = {
									["enabled"] = false,
								...
								["Health"] = {
									...
									["position"] = 20,
									["location"] = "right",
									["code"] = "[(~Dead ? HP:Short:HPColor \" || \" MaxHP:Short:Color(\"2F9717\")) (Dead ? \"Dead\":Color(\"922E21\")) (Offline ? \"Offline\":Color(\"8D8483\"))]",
									["attach_to"] = "BlankSpace;Default",
									["size"] = 0.8,
								},
								["Name + Power"] = {
									...
									["position"] = 5,
									["location"] = "left",
									["code"] = "[(IsMouseOver ? MP:Short:Color(\"76B3EC\") \" || \" MaxMP:Short:Color(\"377BBC\")) (~IsMouseOver ? (Name:ClassColor:Truncate(40) \" \" Level:DifficultyColor \" \" SmartRace:HostileColor \" \" Class:ClassColor))]",
									["attach_to"] = "BlankSpace;Default",
									["size"] = 0.8,
								},
							},
						...
						["Player"] = {
							...
							["elements"] = {
								...
								["Health"] = {
									...
									["position"] = 1.00002,
									["location"] = "right",
									["code"] = " \n[Outline][(~Dead ? HP:Short:HPColor) (Dead ? \"Dead\":Color(\"922E21\"))]",
									["attach_to"] = "InlinePower",
									["size"] = 0.75,
								},
							},
						...
						["focusnew2"] = {
							...
							["elements"] = {
								["Name + HP"] = {
									["exists"] = true,
									["code"] = "[Name:ClassColor:Truncate(30) \" \" Dead:Red]",
									["location"] = "center",
									["attach_to"] = "BlankSpace;Default",
									["size"] = 0.75,
								},
						...
						["Target"] = {
							...
							["elements"] = {
								...
								["Name + Power"] = {
									...
									["position"] = 5,
									["location"] = "center",
									["code"] = "[Outline Name:ClassColor:Truncate(32) (~IsMaxHP ? ~Dead ? \" || \" PercentHP:HPColor \"%\":HPColor) (Dead ? \" || \" \"Dead\":Color(\"922E21\"))] [Offline ? \"Offline\":Color(\"8D8483\")]",
									["attach_to"] = "BlankSpace;Default",
									["size"] = 0.9,
								},
								["Health"] = {
									...
									["position"] = 20,
									["location"] = "right",
									["code"] = " [Outline][(~Dead ? HP:Short:HPColor) (Dead ? \"Dead\":Color(\"922E21\"))]",
									["attach_to"] = "BlankSpace;Default",
									["size"] = 0.75,
								},
							},
						...
						["yopet"] = {
							...
							["elements"] = {
								["Name"] = {
									...
									["position"] = 1.00001,
									["location"] = "edge_bottom",
									["code"] = " [Outline][Name:HPColor:Truncate(44)]",
									["size"] = 0.9,
								},
								["dead"] = {
									["font"] = "Impact",
						...
						["Party c"] = {
							["elements"] = {
								...
								["Lua:Low"] = {
									...
									["exists"] = true,
									["attach_to"] = "HealthBar",
									["code"] = "Outline()\nlocal dead = UnitIsDeadOrGhost(unit)\nif HP(unit) < 7500 and not dead then\nreturn '|cffFAF212LOW|r'\nend\nif dead then\nreturn '|cffA70606DEAD|r'\nend",
								},
								["Lua:Power"] = {
									["enabled"] = false,
									["events"] = {
						...
						["Player"] = {
							["elements"] = {
								...
								["Lua:Power"] = {
									...
									["code"] = "local max = MaxPower(unit)\nif max > 0 then\n  return \"|cff76B3EC%s|r || |cff377BBC%s|r\",Short(Power(unit),true),Short(MaxPower(unit),true)\nend",
									["location"] = "right",
									["attach_to"] = "BlankSpace;Default",
									["exists"] = true,
								},
								["Lua:Health100"] = {
									...
									["code"] = "Outline()\nif Percent(HP(unit),MaxHP(unit)) < 100 then\nreturn \"|cffA50707%s%%|r\",Percent(HP(unit),MaxHP(unit))\nend",
									["location"] = "right",
									["attach_to"] = "HealthBar",
									["exists"] = true,
								},
								...
								["Lua:Health"] = {
									...
									["exists"] = true,
									["attach_to"] = "BlankSpace;Default",
									["code"] = "  local cur,max = HP(unit),MaxHP(unit)\n  local hp_r,hp_g,hp_b = HPColor(cur,max)\n  return \"|cff%02x%02x%02x%s|r || |cff2f9717%s|r \",hp_r,hp_g,hp_b,Short(cur,true),Short(max,true)",
								},
								["Lua:PVPTimer"] = {
									["enabled"] = false,
									["events"] = {
								...
								["Lua:Class"] = {
									...
									["code"] = "if Percent(HP(unit),MaxHP(unit)) < 99.99 and Percent(HP(unit),MaxHP(unit)) > 0.01 then\nreturn '|cff34D12BLOW|r'\nend",
									["location"] = "left",
									["attach_to"] = "PowerBar",
									["exists"] = true,
								},
						...
						["Target"] = {
							["elements"] = {
								...
								["Lua:Name"] = {
									...
									["code"] = "local TrName = Name(unit)\nlocal TrVal = 40\nlocal cr,cg,cb = ClassColor(unit)\nlocal dr,dg,db = DifficultyColor(unit)\nlocal hr,hg,hb = HostileColor(unit)\nif #TrName > TrVal then\n   TrName = strsub(TrName,1,TrVal) .. \".\"\nend\nif IsMouseOver() then\n  return \"|cff76B3EC%s|r || |cff377BBC%s|r\",Short(Power(unit),true),Short(MaxPower(unit),true)\nelse\n  return \"|cff%02x%02x%02x%s|r |cff%02x%02x%02x%s|r |cff%02x%02x%02x%s|r |cff%02x%02x%02x%s|r\",cr,cg,cb,TrName,dr,dg,db,Level(unit),hr,hg,hb,SmartRace(unit),cr,cg,cb,Class(unit)\nend",
									["location"] = "left",
									["attach_to"] = "BlankSpace;Default",
									["exists"] = true,
								},
								...
								["Lua:Health"] = {
									...
									["code"] = "local dead = UnitIsDeadOrGhost(unit)\nlocal offline = not UnitIsConnected(unit) and \" |cff8d8483Offline|r\" or \"\"\nif not dead then\n  local cur,max = HP(unit),MaxHP(unit)\n  local hp_r,hp_g,hp_b = HPColor(cur,max)\n  return \"|cff%02x%02x%02x%s|r || |cff2f9717%s|r%s \",hp_r,hp_g,hp_b,Short(cur,true),Short(max,true),offline\nelse\n  return \"|cff922e21Dead|r%s \",offline\nend",
									["location"] = "right",
									["attach_to"] = "BlankSpace;Default",
									["exists"] = true,
								},
	...
	["profiles"] = {
		...
		["Default"] = {
			...
			["units"] = {
				["player"] = {
					["position_x"] = -261.842058484221,
					["position_y"] = -84.1845973561211,
				},
				["targettargettarget"] = {
				},
				["focus"] = {
		...
		["CaithUI"] = {
			...
			["layouts"] = {
				...
				["focusnew"] = {
					...
					["font"] = "BigNoodleTitling",
					["exists"] = true,
					["indicator_bar_inside_horizontal_padding"] = 2,
					["size_x"] = 225,
					["scale"] = 1.05,
					["bar_texture"] = "Button",
				},
			...
			["units"] = {
				["targettargettarget"] = {
					["enabled"] = false,
					["position_x"] = 348.057096584162,
					["position_y"] = -41.0209789580565,
					["layout"] = "TargetsTarget",
				},
				["focustarget"] = {
					["enabled"] = false,
					["position_x"] = 366.362892294502,
					["position_y"] = 125.007552002705,
					["layout"] = "TargetsTarget",
				},
				["targettarget"] = {
					["position_x"] = 411,
				...
				["focus"] = {
					["position_x"] = 414.855224609375,
					["position_y"] = -122.019866943359,
					["layout"] = "TankTargets",
				},
				["target"] = {
					["position_x"] = 207,
				...
				["pettarget"] = {
					["enabled"] = false,
					["position_x"] = 458.517078814604,
					["position_y"] = 16.4355833192298,
					["layout"] = "Player",
				},
				["focustargettarget"] = {
					["enabled"] = false,
					["position_x"] = 87.1418318298154,
					["position_y"] = 21.9789610511392,
					["layout"] = "TargetsTarget",
				},
				["pet"] = {
					["position_x"] = -443.803070068359,
					["position_y"] = -244.851547241211,
					["layout"] = "yopet",
				},
			},
			["minimap_icon"] = {
				["minimapPos"] = 185.483959221222,
				["hide"] = true,
			},
			["groups"] = {
				["Tank Targets"] = {
					["vertical_spacing"] = 5,
					["direction"] = "up_right",
					["position_x"] = 414.970947265625,
					["group_filter"] = "TANK",
					["layout"] = "TankTargets",
					["enabled"] = true,
					["horizontal_spacing"] = 20,
					["group_by"] = "GROUP",
					["unit_group"] = "raidtarget",
					["exists"] = true,
					["position_y"] = -191.888732910156,
					["units_per_column"] = 5,
					["show_when"] = {
						["party"] = false,
						["raid40"] = true,
				...
				["Raid C"] = {
					["vertical_spacing"] = 20,
					["direction"] = "up_right",
					["position_x"] = 371.244625748513,
					["group_filter"] = "1,3,2,5,4",
					["layout"] = "raid 3 test",
					["horizontal_spacing"] = 20,
					["group_by"] = "GROUP",
					["unit_group"] = "raid",
					["exists"] = true,
					["position_y"] = -204.487539687599,
					["units_per_column"] = 5,
					["show_when"] = {
						["raid25"] = true,
						["raid40"] = true,
