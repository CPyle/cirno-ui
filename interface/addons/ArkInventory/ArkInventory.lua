...
$Revision: 1715 $
$Date: 2016-09-03 22:30:44 +1000 (Sat, 03 Sep 2016) $
...
function ArkInventory.ItemCategoryGetDefaultActual( i )
	...
	if itemType == ArkInventory.Const.ItemClass.CONSUMABLE then
		...
		if ArkInventory.TooltipContains( ArkInventory.Global.Tooltip.Scan, ARTIFACT_POWER, false, true, true, 0, true ) then
			return ArkInventory.CategoryGetSystemID( "SYSTEM_ARTIFACT_RELIC" )
		end
